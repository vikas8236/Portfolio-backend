...
urlpatterns = [
    ...
    path('aboutme/', AboutMeListView.as_view(), name='aboutme-list'),
    path('aboutme/<int:id>/', AboutMeListView.as_view(), name = "aboutme-detail"),
    path('socialmedia/', SocialMediaListView.as_view(), name='socialmedia-list'),
    path('socialmedia/<int:id>/', SocialMediaListView.as_view(), name = "socialmedia-detail"),
    ...
    path('education/<int:id>/', EducationListView.as_view(), name = "education-detail"),
